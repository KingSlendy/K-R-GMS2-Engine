...
if(window_width mod 800 != 0 || window_height mod 608 != 0) {
    ...
    if(aspect_ratio_ratio < 1) {
        ...
        shader_set_uniform_f(u_texelsPerPixel, 800.0 / window_width, 608.0 / canvas_height);
        ...
        shader_set_uniform_f(u_texelsPerPixel, 800.0 / canvas_width, 608.0 / window_height);
